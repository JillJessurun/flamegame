...
void main() {
  ...
  runApp(
    GameWidget(
      game: game,
      overlayBuilderMap: {
        'Start': (context, game) => StartTextOverlay(
          onStart: () {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        Align(
          alignment: Alignment.centerLeft, // Aligns to the left but still vertically centered
          child: Padding(
            padding: const EdgeInsets.only(left: 250), // Moves it a bit to the right
            child: ElevatedButton(
              onPressed: onStart,
              style: ElevatedButton.styleFrom(
              backgroundColor: const Color.fromARGB(0, 0, 0, 0), // Change button color
              foregroundColor: const Color.fromARGB(255, 255, 255, 255), // Change text color
              padding: EdgeInsets.symmetric(horizontal: 64, vertical: 32), // Adjust padding
